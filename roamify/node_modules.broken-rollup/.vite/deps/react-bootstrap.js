import {
  ...
  Modal_default,
  useWillUnmount
} from "./chunk-5FFQSH3C.js";
import {
  Container_default
} from "./chunk-2VLKCU3V.js";
import {
  NavItem_default,
  Nav_default,
  Nav_default2
} from "./chunk-A6F2TGDO.js";
import {
  CardBody_default,
  CardFooter_default,
  CardHeader_default,
  ...
  CardTitle_default,
  Card_default
} from "./chunk-R6ICYSRE.js";
import "./chunk-BMP7ZXCF.js";
import {
  NavbarBrand_default,
...
import {
  ...
  useCallbackRef,
  useNavItem
} from "./chunk-HRYUWTNO.js";
import {
  useIsomorphicEffect_default
} from "./chunk-MG5B766X.js";
import {
  contains,
  useCommittedRef_default,
  useEventCallback
} from "./chunk-JRQ44EUX.js";
import {
  ...
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-BFWNODUW.js";
import {
  useEventCallback as useEventCallback2
} from "./chunk-PNZCNSU3.js";
import {
  Collapse_default,
  createChainedFunction_default
} from "./chunk-UN4ISKXM.js";
import {
  ENTERING,
  EXITING,
...
} from "./chunk-DTGYQCYB.js";
import {
  listen_default,
  ownerDocument,
  require_prop_types,
  useMergedRefs_default
} from "./chunk-OEAJGK2E.js";
...
import {
  Button_default
} from "./chunk-YG3NFGF4.js";
import "./chunk-QP7UCROZ.js";
import {
  DEFAULT_BREAKPOINTS,
  ...
  useBootstrapPrefix,
  useIsRTL
} from "./chunk-X4OWWTD7.js";
import {
  require_classnames
} from "./chunk-H32T6W4N.js";
import {
  require_jsx_runtime
...
var FormControl = React33.forwardRef(({
  ...
  return (0, import_jsx_runtime35.jsx)(Component2, {
    ...
    readOnly,
    id: id || controlId,
    className: (0, import_classnames28.default)(className, plaintext ? `${bsPrefix}-plaintext` : bsPrefix, size && `${bsPrefix}-${size}`, type === "color" && `${bsPrefix}-color`, isValid && "is-valid", isInvalid && "is-invalid")
  });
});
...
var FormLabel = React36.forwardRef(({
  ...
  htmlFor = htmlFor || controlId;
  if (column) return (0, import_jsx_runtime38.jsx)(Col_default, {
    ref,
    as: "label",
    className: classes,
    htmlFor,
...
var InputGroup = React44.forwardRef(({
  ...
  return (0, import_jsx_runtime47.jsx)(InputGroupContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime47.jsx)(Component2, {
      ref,
      ...props,
      className: (0, import_classnames37.default)(className, bsPrefix, size && `${bsPrefix}-${size}`, hasValidation && "has-validation")
    })
  });
});
...
var OverlayTrigger = ({
  ...
  return (0, import_jsx_runtime59.jsxs)(import_jsx_runtime58.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react23.cloneElement)(children, triggerProps), (0, import_jsx_runtime57.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var Pagination = React56.forwardRef(({
  ...
  return (0, import_jsx_runtime62.jsx)("ul", {
    ref,
    ...props,
    className: (0, import_classnames46.default)(className, decoratedBsPrefix, size && `${decoratedBsPrefix}-${size}`)
  });
});
...
function usePlaceholder({
  ...
  return {
    ...colProps,
    className: (0, import_classnames47.default)(className, animation ? `${bsPrefix}-${animation}` : bsPrefix, size && `${bsPrefix}-${size}`, bg && `bg-${bg}`)
  };
}
...
var Spinner = React62.forwardRef(({
  ...
  return (0, import_jsx_runtime68.jsx)(Component2, {
    ref,
    ...props,
    className: (0, import_classnames51.default)(className, bsSpinnerPrefix, size && `${bsSpinnerPrefix}-${size}`, variant && `text-${variant}`)
  });
});
...
var ToastFade = React71.forwardRef((props, ref) => (0, import_jsx_runtime80.jsx)(Fade_default, {
  ...props,
  ref,
